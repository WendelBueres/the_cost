...
import { BtnSalvar, Form, Input, Label } from "../../styles/global"
...
export const BtnApagar = styled(BtnSalvar)`
    background-color: red;
:hover{
        background-color: var(--excluir-hover);

    }
`

export const ContainerRow = styled(ContainerInputGroup)`
    flex-direction: row;
